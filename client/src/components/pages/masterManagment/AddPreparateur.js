...
console.log(isAuth,"isAuthVerif")
  const handleRegister=()=>{
    ...
    const formdata={name,email,password,lastName,role:["Preparateur"]}
...
Ajouter preparateur      </Button>

 <Modal isOpen={modal} toggle={toggle} >
   <ModalHeader className='modHead' toggle={toggle}>Inscrire</ModalHeader>
